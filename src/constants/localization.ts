...
export const LOCALIZED_STRINGS: Record<'bn' | 'en', TranslationSet> = {
  bn: {
    ...
    scrollingNotice: "🏆 SPIN71 BET✨ 🏆 ⭐ প্রথম জমার জন্য ১০০% বোনাস! ⭐ অফিসিয়াল লিংক: https://spin71bet-642.netlify.app/",
  ...
  en: {
    ...
    scrollingNotice: "🏆 SPIN71 BET✨ 🏆 ⭐ 100% Bonus on First Deposit! ⭐ Official Link: https://spin71bet-642.netlify.app/",
