...
export const games: Game[] = [
  ...
  { id: 'spribe_aviator', name: 'Aviator', provider: 'SPRIBE', image: 'https://spin71bet.firebaseapp.com/src/assets/images/flyx_promo.png', category: 'ক্র্যাশ', isHot: true, bgColor: 'from-orange-600 to-orange-900' },
